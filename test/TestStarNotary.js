...
it('can add the star name and star symbol properly', async () => {
  ...
  assert.equal(symbol, 'SSA')
  assert.equal(name, 'Standard Star Asset')
})
...
it('lets 2 users exchange stars', async () => {
  ...
  let user1 = accounts[1]
  let user2 = accounts[2]
  await instance.createStar('star 6', 6, {from: user1})
  await instance.createStar('star 7', 7, {from: user2})
  instance.exchangeStars(6, 7)
...
it('lets a user transfer a star', async () => {
  ...
  instance.transferStar(user2, tokenId, {from: user1})
